...
* **[🐍 Scripts & Automação](./scripts-and-automation/):** Ferramentas autorais para Resposta Ativa (IPS), análise forense de logs e verificação de integridade de arquivos.
