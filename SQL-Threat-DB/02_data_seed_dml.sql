...
-- 1. Populando os Módulos do Curso (Ignora se já existirem)
INSERT OR IGNORE INTO tb_modulos_curso (modulo_id, numero_modulo, nome_modulo, foco_principal) VALUES
...
INSERT OR IGNORE INTO tb_questoes_quiz (modulo_id, pergunta, opcao_a, opcao_b, opcao_c, opcao_d, resposta_correta, explicacao) VALUES
...
INSERT OR IGNORE INTO tb_threat_logs (ip_origem, tentativas_falhas, status_resolucao) VALUES
